...
public partial class UpdateEventModal : BaseComponent
{
    [Inject] public required IEventService EventService { get; set; }
    [CascadingParameter] BlazoredModalInstance BlazoredModal { get; set; } = default!;
    [Parameter] public UpdateEventRequest EventModel { get; set; }
    ...
    private async Task HandleSubmit()
    {
        ...
        {
            shouldRender = false;
            var response = await EventService.UpdateAsync(EventModel);
